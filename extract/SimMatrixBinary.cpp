 ...
 * Constructor
 */
SimMatrixBinary::SimMatrixBinary(EMatrix *ematrix, int quiet,
    char * cmethod, int x_coord, int y_coord, char * gene1, char * gene2, float th)
  : SimilarityMatrix(ematrix, quiet, cmethod, x_coord, y_coord, gene1, gene2, th){
